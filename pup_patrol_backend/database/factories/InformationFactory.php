...
class InformationFactory extends Factory
{
    ...
    public $information = [
        [
          ...
          "information_image_name"=> "images/Golden Retriever.png"
        ],
        [
          ...
          "information_image_name"=> "images/Maltipoo.png"
        ],
        [
          ...
          "information_image_name"=> "images/Shiba Inu.png"
        ],
        [
          ...
          "information_image_name"=> "images/Border Collie.png"
        ],
        [
          ...
          "information_image_name"=> "images/Samoyed.png"
        ],
        [
          ...
          "information_image_name"=> "images/Mini Bichon.png"
        ],
        [
          ...
          "information_image_name"=> "images/Bernese Mountain.png"
        ],
        [
          ...
          "information_image_name"=> "images/Rough Collie.png"
        ],
        [
          ...
          "information_image_name"=> "images/Maltese.png"
        ]
        ];
    public $index = -1;
    public function definition(): array
    {
        ...
        return [
            ...
            "information_image_name"=>$temp["information_image_name"],
        ];
    }
}
