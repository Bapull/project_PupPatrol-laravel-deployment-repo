...
class InformationFactory extends Factory
{
    ...
    public $information = [
        [
          ...
          "information_image_name"=> "Golden Retriever.png"
        ],
        [
          ...
          "information_image_name"=> "Maltipoo.png"
        ],
        [
          ...
          "information_image_name"=> "Shiba Inu.png"
        ],
        [
          ...
          "information_image_name"=> "Border Collie.png"
        ],
        [
          ...
          "information_image_name"=> "Samoyed.png"
        ],
        [
          ...
          "information_image_name"=> "Mini Bichon.png"
        ],
        [
          ...
          "information_image_name"=> "Bernese Mountain.png"
        ],
        [
          ...
          "information_image_name"=> "Rough Collie.png"
        ],
        [
          ...
          "information_image_name"=> "Maltese.png"
        ]
        ];
    public $index = -1;
